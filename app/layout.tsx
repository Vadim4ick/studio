...
export const metadata: Metadata = {
  ...
  description:
    "Полный спектр услуг по созданию и продвижению сайтов от веб-студии Barbaris. Получите свои первые заказы от наших сатов оптимизированных под введение бизнеса в интернете",
  keywords:
